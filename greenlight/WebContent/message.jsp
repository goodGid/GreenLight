...
List<msgDTO> list=(List)session.getAttribute("Receivelist");
if(session.getAttribute("Receivelist")!=null)
{System.out.println("111");
   // List<msgDTO> list=(List)session.getAttribute("Receivelist");
...
<body>
 ...
 <!-- Service Panels -->
        <!-- The circle icons use Font Awesome's stacked icon classes. For more information, visit http://fontawesome.io/examples/ -->
           <div class="row">
              <h2 class="page-header">IN BOX</h2>
            </div>
           ...
           <div class="modal-dialog">
              <div class="modal-content">
                 <div class="modal-header">
                    ...
                    <h3 class="modal-title" id="modal-register-label">쪽지 내용</h3>
